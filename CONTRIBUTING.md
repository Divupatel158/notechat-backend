# Contributing to NoteChat Backend

We love your input! We want to make contributing to NoteChat Backend as easy and transparent as possible, whether it's:
...
perf: optimize note retrieval query
...
## Report bugs using Github's [issue tracker](https://github.com/yourusername/notechat-backend/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/yourusername/notechat-backend/issues/new); it's that easy!
